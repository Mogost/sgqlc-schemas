...
init = sgqlc.types.Schema()


# Unexport Node/PageInfo, let schema re-declare them
init -= sgqlc.types.relay.Node
init -= sgqlc.types.relay.PageInfo
...
# Schema Entry Points
########################################################################
init.query_type = Query
init.mutation_type = Mutation
init.subscription_type = None
